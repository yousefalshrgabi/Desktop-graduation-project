                ...
                child: Column(
                  ...
                  children: request.type == 'طلب من النيابة العامة'
                      ? [
                          ...
                          const SizedBox(height: 16),
                          _buildInfoRow(
                              'الجهة المرسلة:', request.senderCollege),
                          const SizedBox(height: 12),
        ...
        if (isReceived && req.status == 'قيد الانتظار') {
          if (isLeaveRequest) {
            ...
            if (currentStep == 1 && _session.isDeptHead) {
              ...
              if (reqDept != null &&
                  myDept != null &&
                  _viewModel.isSameDepartment(reqDept, myDept)) {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        ...(req.extraData!['approval_history'] as List<dynamic>)
                            .map((item) {
