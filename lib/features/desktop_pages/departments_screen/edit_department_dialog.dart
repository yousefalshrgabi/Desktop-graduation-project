...
class _EditDepartmentDialogState extends State<EditDepartmentDialog> {
  ...
  void initState() {
    ...
    _selectedCollegeId = widget.department.collegeId.isNotEmpty
        ? widget.department.collegeId
        : null;
    _selectedHodId =
        widget.department.hodId.isNotEmpty ? widget.department.hodId : null;
  ...
  Future<void> _update() async {
    ...
    try {
      await widget.viewModel.updateDepartment(widget.department.id, {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const Text('تعديل القسم', style: DesktopTextStyles.heading1),
                    IconButton(
      ...
      items: [
        if (nullable)
          const DropdownMenuItem(
              value: null, child: Text('لا يوجد (غير محدد)')),
