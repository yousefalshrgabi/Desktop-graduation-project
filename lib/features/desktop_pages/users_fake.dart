...
class UsersFake extends StatelessWidget {
  const UsersFake({super.key});
          ...
          return Column(
            ...
            children: [
              CustomDataTable(
                ...
                // 3. تمرير الصفوف (Rows) عن طريق عمل Map للبيانات
                rows: users.map((doc) {
                  ...
                  return DataRow(cells: [
                    ...
                    DataCell(_buildRoleBadge(role)), // استدعاء دالة الشارة
                    DataCell(Text(createdAt, style: DesktopTextStyles.caption)),
                    DataCell(
                      // زر الإجراءات (حذف/تعديل)
                ...
                }).toList(), // تحويل الـ map إلى List<DataRow>
              ),
            ],
          );
        },
